...
```
C:\Users\ryanv\OneDrive\Desktop\AI Projects\Parsec
```

## Open the Editor

```powershell
& "C:\Users\ryanv\Downloads\Godot_v4.6.3-stable_win64.exe\Godot_v4.6.3-stable_win64.exe" --path "C:\Users\ryanv\OneDrive\Desktop\AI Projects\Parsec" --editor
```

## Run a Specific Scene

```powershell
& "C:\Users\ryanv\Downloads\Godot_v4.6.3-stable_win64.exe\Godot_v4.6.3-stable_win64.exe" --path "C:\Users\ryanv\OneDrive\Desktop\AI Projects\Parsec" --scene "res://scenes/menu/menu.tscn"
```
